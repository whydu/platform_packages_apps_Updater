...
public final class Constants {
    ...
    public static final String PROP_BUILD_VERSION = "ro.du.build.version";
    public static final String PROP_DEVICE = "ro.product.device";
    public static final String PROP_NEXT_DEVICE = "ro.updater.next_device";
    public static final String PROP_RELEASE_TYPE = "ro.du.buildtype";
    public static final String PROP_UPDATER_ALLOW_DOWNGRADING = "du.updater.allow_downgrading";
    public static final String PROP_UPDATER_URI = "du.updater.uri";
